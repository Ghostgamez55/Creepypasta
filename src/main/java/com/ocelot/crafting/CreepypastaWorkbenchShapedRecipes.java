...
public class CreepypastaWorkbenchShapedRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements net.minecraftforge.common.crafting.IShapedRecipe {
	...
	public CreepypastaWorkbenchShapedRecipes(String group, int width, int height, NonNullList<Ingredient> ingredients, ItemStack result) {
		this.group = group;
	...
	public static CreepypastaWorkbenchShapedRecipes deserialize(JsonObject p_193362_0_) {
		...
		return new CreepypastaWorkbenchShapedRecipes(s, i, j, nonnulllist, itemstack);
	}
