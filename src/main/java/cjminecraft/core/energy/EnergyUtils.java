...
public class EnergyUtils {
	 ...
	 * @return The {@link IEnergySupport} for the {@link TileEntity} if it has support. Can be <code>null</code>
	 */
	@Nullable
	 ...
	 * @return The {@link IEnergySupport} for the {@link ItemStack} if it has support. Can be <code>null</code>
	 */
	@Nullable
	...
	/**
	 * Convert one energy unit to another energy unit leaving the conversion in a double and not a long
	 * 
	 * @param from
	 *            The unit the energy is in
	 * @param to
	 ...
	 * @param from
	 *            The side of the {@link TileEntity} for use with {@link Capability}
	 * @return The amount of energy stored in the {@link TileEntity} in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	 ...
	 * @param from
	 *            The side of the {@link ItemStack} for use with {@link Capability}
	 * @return The amount of energy stored in the {@link ItemStack} in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	...
	public static long getEnergyStored(@Nullable TileEntity te, @Nullable EnumFacing from, @Nonnull EnergyUnit unit) {
		...
		if (support != null)
			return convertEnergy(support.defaultEnergyUnit(), unit, support.getEnergyStored(support.getContainer(te, from), from));
		return 0;
	}
	...
	public static long getEnergyStored(@Nullable ItemStack stack, @Nullable EnumFacing from, @Nonnull EnergyUnit unit) {
		...
		if (support != null)
			return convertEnergy(support.defaultEnergyUnit(), unit, support.getEnergyStored(support.getContainer(stack, from), from));
		return 0;
	}
	 ...
	 * @param from
	 *            The side of the {@link TileEntity} for use with {@link Capability}
	 * @return The maximum amount of energy in the {@link TileEntity} in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	 ...
	 * @param from
	 *            The side of the {@link ItemStack} for use with {@link Capability}
	 * @return The maximum amount of energy in the {@link ItemStack} in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	...
	public static long getCapacity(@Nullable TileEntity te, @Nullable EnumFacing from, @Nonnull EnergyUnit unit) {
		IEnergySupport support = getEnergySupport(te, from);
		if (support != null)
			return convertEnergy(support.defaultEnergyUnit(), unit, support.getCapacity(support.getContainer(te, from), from));
		return 0;
	}
	...
	public static long getCapacity(@Nullable ItemStack stack, @Nullable EnumFacing from, @Nonnull EnergyUnit unit) {
		IEnergySupport support = getEnergySupport(stack, from);
		if (support != null)
			return convertEnergy(support.defaultEnergyUnit(), unit, support.getCapacity(support.getContainer(stack, from), from));
		return 0;
	}
	 ...
	 * @param energy
	 *            The energy to be given in the {@link EnergyUnits#MINECRAFT_JOULES} unit
	 * @param simulate
	 *            Whether or not it is a simulation. If so, no energy is actually given
	 * @param from
	 *            The side of the {@link TileEntity} for use with {@link Capability}
	 * @return The amount of energy which was given (or would have been given if it is simulated) in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	 ...
	 * @param from
	 *            The side of the {@link TileEntity} for use with {@link Capability}
	 * @return The amount of energy which was given (or would have been given if it is simulated) in the {@link EnergyUnit} provided
	 */
	public static long giveEnergy(TileEntity te, long energy, @Nonnull EnergyUnit unit, boolean simulate, EnumFacing from) {
		...
		if (support != null && support.canReceive(support.getContainer(te, from), from))
			return convertEnergy(support.defaultEnergyUnit(), unit, support.giveEnergy(support.getContainer(te, from), convertEnergy(unit, support.defaultEnergyUnit(), energy), simulate, from));
		return 0;
	}
	 ...
	 * @return The amount of energy which was given (or would have been given if it is simulated) in the {@link EnergyUnit} provided
	 */
	public static long giveEnergy(ItemStack stack, long energy, @Nonnull EnergyUnit unit, boolean simulate, EnumFacing from) {
		...
		if (support != null && support.canReceive(support.getContainer(stack, from), from))
			return convertEnergy(support.defaultEnergyUnit(), unit, support.giveEnergy(support.getContainer(stack, from), convertEnergy(unit, support.defaultEnergyUnit(), energy), simulate, from));
		return 0;
	}
	 ...
	 * @param energy
	 *            The energy to be taken in the {@link EnergyUnits#MINECRAFT_JOULES} unit
	 * @param simulate
	 *            Whether or not it is a simulation. If so, no energy is actually taken
	 * @param from
	 *            The side of the {@link TileEntity} for use with {@link Capability}
	 * @return The amount of energy which was taken (or would have been taken if it is simulated) in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	 ...
	 * @param from
	 *            The side of the {@link TileEntity} for use with {@link Capability}
	 * @return The amount of energy which was taken (or would have been taken if it is simulated) in the {@link EnergyUnit} provided
	 */
	public static long takeEnergy(TileEntity te, long energy, @Nonnull EnergyUnit unit, boolean simulate, EnumFacing from) {
		...
		if (support != null && support.canExtract(support.getContainer(te, from), from))
			return convertEnergy(support.defaultEnergyUnit(), unit, support.takeEnergy(support.getContainer(te, from), convertEnergy(unit, support.defaultEnergyUnit(), energy), simulate, from));
		return 0;
	}
	 ...
	 * @return The amount of energy which was taken (or would have been taken if it is simulated) in the {@link EnergyUnit} provided
	 */
	public static long takeEnergy(ItemStack stack, long energy, @Nonnull EnergyUnit unit, boolean simulate, EnumFacing from) {
		...
		if (support != null && support.canExtract(support.getContainer(stack, from), from))
			return convertEnergy(support.defaultEnergyUnit(), unit, support.takeEnergy(support.getContainer(stack, from), convertEnergy(unit, support.defaultEnergyUnit(), energy), simulate, from));
		return 0;
	}
	 ...
	 *            The {@link TileEntity} which holds energy
	 * @param energy
	 *            The energy to set in the {@link EnergyUnits#MINECRAFT_JOULES} unit
	 * @param from
	 *            The side of the {@link TileEntity} for use with {@link Capability} {@link Capability}
	 * @return The energy which was set in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	 ...
	 *            The center position
	 * @param energy
	 *            The energy to take altogether. Will be distributed evenly between the {@link TileEntity}s. Needs to be in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 * @param simulate
	 *            Whether it is a simulation or not. If so, the energy won't actually be taken
	 * @return The amount of energy taken in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	 ...
	 *            The center position
	 * @param energy
	 *            The energy to give altogether. Will be distributed evenly between the {@link TileEntity}s. Needs to be in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 * @param simulate
	 *            Whether it is a simulation or not. If so, the energy won't actually be given
	 * @return The amount of energy given in the {@link EnergyUnit} {@link EnergyUnits#MINECRAFT_JOULES}
	 */
	@Deprecated
	 ...
	 *            The center position
	 * @param energy
	 *            The energy to take altogether. Will be distributed evenly between the {@link TileEntity}s. Needs to be in the {@link EnergyUnit} provided
	 * @param unit
	 ...
	 */
	public static long takeEnergyAllFaces(@Nonnull World world, BlockPos pos, long energy, @Nonnull EnergyUnit unit, boolean simulate) {
	 ...
	 *            The center position
	 * @param energy
	 *            The energy to give altogether. Will be distributed evenly between the {@link TileEntity}s. Needs to be in the {@link EnergyUnit} provided
	 * @param unit
	 ...
	 */
	public static long giveEnergyAllFaces(@Nonnull World world, BlockPos pos, long energy, @Nonnull EnergyUnit unit, boolean simulate) {
		HashMap<EnumFacing, TileEntity> tiles = new HashMap<EnumFacing, TileEntity>();
		for (EnumFacing side : EnumFacing.VALUES) {
			TileEntity te = world.getTileEntity(pos.offset(side));
			if (te == null)
	...
	/**
	 * Sync energy with the server. To get the data use {@link #getCachedEnergyData(String)} or {@link #getCachedEnergyData(String, String)} and then use {@link EnergyData#getEnergy()}. This will store the data in the calling class in the cache
	 * 
	 * @param pos
	...
	public static void syncEnergy(BlockPos pos, @Nullable EnumFacing side, String modid) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergy(EnergyUnits.MINECRAFT_JOULES, pos, side, false, modid, new Exception().getStackTrace()[1].getClassName()));
	}

	/**
	 * Sync energy with the server. To get the data use {@link #getCachedEnergyData(String)} or {@link #getCachedEnergyData(String, String)} and then use {@link EnergyData#getEnergy()}. This will store the data in the class path provided in the cache
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	...
	/**
	 * Sync capacity with the server. To get the data use {@link #getCachedEnergyData(String)} or {@link #getCachedEnergyData(String, String)} and then use {@link EnergyData#getCapacity()}. This will store the data in the calling class in the cache
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	...
	public static void syncCapacity(BlockPos pos, @Nullable EnumFacing side, String modid) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetCapacity(EnergyUnits.MINECRAFT_JOULES, pos, side, false, modid, new Exception().getStackTrace()[1].getClassName()));
	}

	/**
	 * Sync capacity with the server. To get the data use {@link #getCachedEnergyData(String)} or {@link #getCachedEnergyData(String, String)} and then use {@link EnergyData#getEnergy()}. This will store the data in the class path provided in the cache
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	...
	/**
	 * Sync {@link EnergyData} with the server. To get the data use {@link #getCachedEnergyData(String)} or {@link #getCachedEnergyData(String, String)}. This will store the data in the calling class in the cache
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	...
	public static void syncEnergyData(BlockPos pos, @Nullable EnumFacing side, String modid) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergyData(EnergyUnits.MINECRAFT_JOULES, pos, side, false, modid, new Exception().getStackTrace()[1].getClassName()));
	}

	/**
	 * Sync {@link EnergyData} with the server. To get the data use {@link #getCachedEnergyData(String)} or {@link #getCachedEnergyData(String, String)} and then use {@link EnergyData#getEnergy()}. This will store the data in the class path provided in the cache
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	...
	/**
	 * Sync energy using a {@link Field} in the calling class. This will set the fields value to the energy of the {@link TileEntity} at the given {@link BlockPos}
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	 ...
	 *            The name of the field which will hold the energy. Must be a <code>long</code>
	 */
	@Deprecated
	public static void syncEnergyField(BlockPos pos, @Nullable EnumFacing side, String energyFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergy(EnergyUnits.MINECRAFT_JOULES, pos, side, true, new Exception().getStackTrace()[1].getClassName(), energyFieldName));
	}

	/**
	 * Sync energy using a {@link Field} in the class provided. This will set the fields value to the energy of the {@link TileEntity} at the given {@link BlockPos}
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	 ...
	 */
	@Deprecated
	public static void syncEnergyField(BlockPos pos, @Nullable EnumFacing side, String className, String energyFieldName) {
	...
	/**
	 * Sync capacity using a {@link Field} in the calling class. This will set the fields value to the capacity of the {@link TileEntity} at the given {@link BlockPos}
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	 ...
	 *            The name of the field which will hold the capacity. Must be a <code>long</code>
	 */
	@Deprecated
	public static void syncCapacityField(BlockPos pos, @Nullable EnumFacing side, String capacityFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetCapacity(EnergyUnits.MINECRAFT_JOULES, pos, side, true, new Exception().getStackTrace()[1].getClassName(), capacityFieldName));
	}

	/**
	 * Sync capacity using a {@link Field} in the class provided. This will set the fields value to the capacity of the {@link TileEntity} at the given {@link BlockPos}
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	 ...
	 */
	@Deprecated
	public static void syncCapacityField(BlockPos pos, @Nullable EnumFacing side, String className, String capacityFieldName) {
	...
	/**
	 * Sync energy and capacity using {@link Field}s in the calling class. This will set the fields values to the energy and capacity (each respectively) of the {@link TileEntity} at the given {@link BlockPos}
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	 ...
	 */
	@Deprecated
	public static void syncEnergyDataFields(BlockPos pos, @Nullable EnumFacing side, String energyFieldName, String capacityFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergyData(EnergyUnits.MINECRAFT_JOULES, pos, side, true, new Exception().getStackTrace()[1].getClassName(), energyFieldName, capacityFieldName));
	}

	/**
	 * Sync energy and capacity using {@link Field}s in the class provided. This will set the fields values to the energy and capacity (each respectively) of the {@link TileEntity} at the given {@link BlockPos}
	 * 
	 * @param pos
	 *            The position of the {@link TileEntity}
	 * @param side
	 ...
	 */
	@Deprecated
	public static void syncEnergyDataFields(BlockPos pos, @Nullable EnumFacing side, String className, String energyFieldName, String capacityFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergyData(EnergyUnits.MINECRAFT_JOULES, pos, side, true, className, energyFieldName, capacityFieldName));
	}
	...
	public static void syncEnergy(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String modid) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergy(unit, pos, side, false, modid, new Exception().getStackTrace()[1].getClassName()));
	}
	 ...
	 *            The name of the class for the cache
	 */
	public static void syncEnergy(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String modid, String className) {
	...
	public static void syncCapacity(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String modid) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetCapacity(unit, pos, side, false, modid, new Exception().getStackTrace()[1].getClassName()));
	}
	 ...
	 *            The name of the class for the cache
	 */
	public static void syncCapacity(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String modid, String className) {
	...
	public static void syncEnergyData(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String modid) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergyData(unit, pos, side, false, modid, new Exception().getStackTrace()[1].getClassName()));
	}
	 ...
	 *            The name of the class for the cache
	 */
	public static void syncEnergyData(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String modid, String className) {
	 ...
	 *            The name of the field which will hold the energy. Must be a <code>long</code>
	 */
	public static void syncEnergyField(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String energyFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergy(unit, pos, side, true, new Exception().getStackTrace()[1].getClassName(), energyFieldName));
	}
	 ...
	 *            The name of the field which will hold the energy. Must be a <code>long</code>
	 */
	public static void syncEnergyField(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String className, String energyFieldName) {
	 ...
	 *            The name of the field which will hold the capacity. Must be a <code>long</code>
	 */
	public static void syncCapacityField(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String capacityFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetCapacity(unit, pos, side, true, new Exception().getStackTrace()[1].getClassName(), capacityFieldName));
	}
	 ...
	 *            The name of the field which will hold the capacity. Must be a <code>long</code>
	 */
	public static void syncCapacityField(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String className, String capacityFieldName) {
	 ...
	 *            The name of the field which will hold the capacity. Must be a <code>long</code>
	 */
	public static void syncEnergyDataFields(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String energyFieldName, String capacityFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergyData(unit, pos, side, true, new Exception().getStackTrace()[1].getClassName(), energyFieldName, capacityFieldName));
	}
	 ...
	 *            The name of the field which will hold the capacity. Must be a <code>long</code>
	 */
	public static void syncEnergyDataFields(@Nonnull EnergyUnit unit, BlockPos pos, @Nullable EnumFacing side, String className, String energyFieldName, String capacityFieldName) {
		PacketHandler.INSTANCE.sendToServer(new PacketGetEnergyData(unit, pos, side, true, className, energyFieldName, capacityFieldName));
	}

	/**
	 * Gets the durability for use with a durability bar for the given {@link ItemStack}
	 * 
	 * @param stack
	...
	/**
	 * Get the RGB colour of the durability bar that the given {@link ItemStack} will use
	 * 
	 * @param stack
	 *            The {@link ItemStack} which holds energy
	...
	public static void addEnergyInformation(ItemStack stack, List<String> tooltip) {
		if (hasSupport(stack, null)) {
			if (CJCoreConfig.ENERGY_BAR_SIMPLIFY_ENERGY) {
				tooltip.add(getEnergyAsString(getEnergyStored(stack, null, CJCoreConfig.DEFAULT_ENERGY_UNIT), CJCoreConfig.DEFAULT_ENERGY_UNIT) + (CJCoreConfig.ENERGY_BAR_SHOW_CAPACITY ? " / " + getEnergyAsString(getCapacity(stack, null, CJCoreConfig.DEFAULT_ENERGY_UNIT), CJCoreConfig.DEFAULT_ENERGY_UNIT) : ""));
			} else {
				tooltip.add(NumberFormat.getInstance().format(getEnergyStored(stack, null, CJCoreConfig.DEFAULT_ENERGY_UNIT)) + " " + CJCoreConfig.DEFAULT_ENERGY_UNIT.getSuffix() + (CJCoreConfig.ENERGY_BAR_SHOW_CAPACITY ? " / " + NumberFormat.getInstance().format(getCapacity(stack, null, CJCoreConfig.DEFAULT_ENERGY_UNIT)) + " " + CJCoreConfig.DEFAULT_ENERGY_UNIT.getSuffix() : ""));
			}
		}
	}
