...
/**
 * A set which will put all {@link ItemStack}'s with the same description together rather than separately, the count will most likely exceed 64
 * 
 * @author CJMinecraft
 *
 */
public class ItemStackSet implements Set<ItemStack>, Iterable<ItemStack> {
	...
	/**
	 * @return the item stacks all with the count representative of all those in the stacks of similar description
	 */
