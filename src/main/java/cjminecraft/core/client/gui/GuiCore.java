...
public abstract class GuiCore extends GuiContainer {
	 ...
	 * @return The {@link Slot} the player is hovering over. Returns null if the player is not hovering over a slot
	 */
	...
	public void drawTiledTexture(int x, int y, TextureAtlasSprite icon, int width, int height) {
		for (int offsetX = 0; offsetX < width; offsetX += 16) {
			for (int offsetY = 0; offsetY < height; offsetY += 16) {
				drawScaledTexturedModelRectFromIcon(x + offsetX, y + offsetY, icon, Math.min(width - offsetX, 16), Math.min(height - offsetY, 16));
			}
		}
	...
	/**
	 * Draw a rectangle of one colour from the given locations. Alpha is blended correctly
	 * 
	 * @param x1
	 *            The left position
	 * @param y1
	 ...
	 *            The bottom position
	 * @param colour
	 *            The colour in format 0xAARRGGBB. A = Alpha, R = Red, G = Green, B = Blue
	 */
	...
	/**
	 * Draw a textured rectangle at the positions given with the UV provided. The texture will be stretched to meet the texture width and height
	 * 
	 * @param x
	 ...
	 */
	public void drawSizedTexturedModalRect(int x, int y, int u, int v, int width, int height, float textureWidth, float textureHeight) {
		Gui.drawModalRectWithCustomSizedTexture(x, y, u, v, width, height, textureWidth, textureHeight);
	}

	/**
	 * Draw a textured rectangle at the positions given with the UV provided. The texture will be stretched to meet the texture width and height. There will be a border around it
	 * 
	 * @param x
	 *            The x position of the rectangle on the screen
	 * @param y
	 ...
	 *            The height of the rectangle on the texture
	 */
	public void drawSizedTexturedModalRectWithBorder(int x, int y, int u, int v, int width, int height, float textureWidth, float textureHeight) {
	...
	/**
	 * Draw a textured rectangle at the positions given with the UV provided, with a border around it
	 * 
	 * @param x
	 *            The x position of the rectangle on the screen
	 * @param y
	...
	/**
	 * Draw a rectangle of one colour from the given locations. Alpha is blended correctly. Will draw a border around it
	 * 
	 * @param x1
	 *            The left position
	 * @param y1
	...
	/**
	 * Draw a rectangle of one colour from the given locations. No blending used. Will draw a border around it
	 * 
	 * @param x1
	 *            The left position
	 * @param y1
