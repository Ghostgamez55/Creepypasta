...
/**
 * Base class for use with the {@link RenderGameOverlayEvent} which holds multiple overlays. Make your class extend this and make sure to register the event using {@link MinecraftForge#EVENT_BUS}
 * 
 * @author CJMinecraft
 *
 */
